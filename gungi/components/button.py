import pygame
from ..constants import BUTTON_BORDER_COLOR, BUTTON_BORDER_THICKNESS, BUTTON_CLICKED_COLOR, BUTTON_COLOR, BUTTON_HIGHLIGHTED_COLOR, BLACK
...
class Button:
    ...
    def click(self, button_name, button_function, game: Game):
        self.clicked = True
